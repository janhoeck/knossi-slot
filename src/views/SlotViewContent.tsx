...
export const SlotViewContent = (props: SlotViewContentProps) => {
    ...
    const { registerSlot, symbolsMap, rowsAmount, columnsAmount, lastAmountOfProfit } = useSlotContext();
    ...
    return (
        <div className={classNames(classes.root, className)} {...restProps} >
            <div className={classes.slotContainer}>
                ...
                <Slot className={classes.slot} ref={registerSlot} symbolsMap={symbolsMap} rowsAmount={rowsAmount} columnsAmount={columnsAmount} />
            </div>
